...
def load_pems_data(rootpath, name, adj_mx_name, ratio=1.0, one_node=False, one_sample=False):
    ...
    FEATURE_START, FEATURE_END = 0, 140
    ATTR_START, ATTR_END = 140, 141
    ...
    for name in ['train', 'val', 'test']:
        ...
        x_attr = raw_data[name]['x'][..., ATTR_START:ATTR_END]
        y_attr = raw_data[name]['y'][..., ATTR_START:ATTR_END]
...
available_datasets = {
    'POI': partial(load_pems_data, rootpath='data',
        name='POI', adj_mx_name='adj_mx_poi.pkl'),
